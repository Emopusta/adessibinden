...
public class AuthManager : IAuthService
{
    ...
    private readonly IGenericRepository<UserOperationClaim> _userOperationClaimRepository;

    public AuthManager(
        IGenericRepository<UserOperationClaim> userOperationClaimRepository,
